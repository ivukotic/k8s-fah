...
# Install
## ONLY CPU 
```kubectl apply -f https://raw.githubusercontent.com/ivukotic/k8s-fah/master/folding-cpu.yaml```  

## ONLY GPU (Nvidia)
```kubectl apply -f https://raw.githubusercontent.com/ivukotic/k8s-fah/master/folding-gpu.yaml```

## CPU & GPU (Nvidia)
```kubectl apply -f https://raw.githubusercontent.com/ivukotic/k8s-fah/master/folding-gpu-cpu.yaml```  
...
```kubectl apply -f https://raw.githubusercontent.com/ivukotic/k8s-fah/master/folding-daemonset.yaml```    
